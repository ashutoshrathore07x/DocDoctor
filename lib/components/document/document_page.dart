...
import 'package:doc_doctor/components/document/state/document_controller.dart';

import 'package:doc_doctor/components/document/widgets/widgets.dart';
...
class __DocumentEditorState extends ConsumerState<_DocumentEditorWidget> {
  ...
  Widget _defaultEmbedBuilderWeb(BuildContext context,
      QuillController controller, Embed node, bool readOnly,  void Function(GlobalKey<State<StatefulWidget>>)? callback) {
